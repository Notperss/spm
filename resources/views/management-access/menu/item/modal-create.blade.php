<!-- Modals add menu -->
<div id="modal-form-add-menu-item" class="modal fade" tabindex="-1" aria-labelledby="modal-form-add-menu-item-label"
    ...
    <div class="modal-content">
      <form action="{{ route('menu.item.store', $menu) }}" method="post">
        ...
        <div class="modal-header">
          <h5 class="modal-title" id="modal-form-add-menu-item-label">Add Menu Item</h5>
