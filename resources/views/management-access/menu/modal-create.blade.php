      ...
      <form action="{{ route('menu.store') }}" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <select class="form-control select2" id="permission_name" name="permission_name">
          ...
          <div class="mb-3" id="route-wrapper">
          ...
          <div class="mb-3">
            <div class="form-check form-switch form-switch-right form-switch-md">
              <label for="child_menu" class="form-label">Has Sub Menu</label>
              <input class="form-check-input" type="checkbox" id="child_menu" name="child_menu" value="1">
            </div>
          </div>
