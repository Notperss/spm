...
<head>
  ...
  <!-- Primary Meta Tags -->
  <title>{{ env('APP_NAME') }} | 500 Server Error</title>
        ...
        <div class="row align-items-center">
          <div class="col-12 col-lg-5 order-2 order-lg-1 text-center text-lg-left">
            ...
            <a href="{{ route('dashboard.index') }}"
              class="btn btn-gray-800 d-inline-flex align-items-center justify-content-center mb-4"><svg
          ...
          <div class="col-12 col-lg-7 order-1 order-lg-2 text-center d-flex align-items-center justify-content-center">
            <img class="img-fluid w-75" src="{{ asset('dist/assets/img/illustrations/500.svg') }}"
