!(function (global, factory) {
    ...
    function observeDOM(obj, callback) {
        ...
        if (MutationObserver) {
            ...
            return (obs.observe(obj, { childList: !0, subtree: !0 }), obs);
        }
        return (
            obj.addEventListener("DOMNodeInserted", callback, !1),
    ...
    function debouncedScroll() {
        var _this = this,
            timeout = void 0;
        return this.options.debounce === !1
            ? function () {
    ...
    function destroy() {
        (this._observer instanceof MutationObserver &&
    ...
    function OnScreen() {
        ...
        ((this.options = {}),
            ...
            Object.defineProperties(this.options, {
                ...
                debounce: {
                    get: function () {
                        return options.debounce === !1
                            ? !1
                            : parseInt(options.debounce, 10) || 100;
                    },
                    set: function (value) {
